 ...
 * summaries is derived: summarized chunks = chunks − pending. The Research tab
 * shows just that summaries count; the Summaries tab — where the backlog is the
 * point — shows both summaries and pending summaries (`showPending`).
 */
export default function IndexMeta({
  ...
  if (showPending && project.pending_summaries > 0) {
